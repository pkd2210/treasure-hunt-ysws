...
<div style="width: 100%; max-width: 800px; margin: 20px auto; filter: drop-shadow(8px 8px 0px rgba(27, 45, 72, 0.15));">
  <svg viewBox="0 0 800 1000" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(80, 180)">
      ...
      <text x="0" y="295" font-family="'Luckiest Guy', cursive" font-weight="bold" font-size="16" fill="#1B2D48">SCREENSHOT</text>
      <foreignObject x="0" y="305" width="640" height="120">
      <div style="width: 100%; height: 100%; background: #E8D5A0; border: 2px dashed #1B2D48; border-radius: 8px; padding: 10px; box-sizing: border-box; font-family: 'Luckiest Guy', cursive; color: #1B2D48; display: flex; align-items: center; justify-content: center; text-align: center;">Drop your map (image) here...</div>
      </foreignObject>
      ...
      <!-- Hackatime Project -->
      <text x="0" y="585" font-family="'Luckiest Guy', cursive" font-weight="bold" font-size="16" fill="#1B2D48">HACKATIME PROJECT NAME</text>
      <foreignObject x="0" y="595" width="640" height="40">
      ...
      <foreignObject x="195" y="680" width="263" height="46">
        <button
          type="button"
